...
export default function Home() {
  ...
  return (
    <main className={`absolute -z-20 ${backgroundUrl} h-full w-full`}>
      ...
      <a href="./inse" className="ml-12 absolute aling-center bottom-10 bg-[#80B48B] hover:bg-[#6C9675] focus:outline-none focus:bg-green-300 rounded-md py-2 px-4 text-white">Inicia sesión</a>
